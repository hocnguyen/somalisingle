...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `seeking` int(1) DEFAULT NULL COMMENT '0: male. 1 :female',
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password`, `role`, `vericode`, `username`, `gender`, `seeking`, `birthday`, `country_id`, `about_me`, `ethnicity`, `height`, `body`, `eyes`, `hair`, `smoke`, `drink`, `education`, `marital_status`, `living_current`) VALUES
(1, NULL, NULL, 'hocnv@gmail.com', '12345678', NULL, NULL, 'hocnv.qn', NULL, NULL, NULL, 243, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
