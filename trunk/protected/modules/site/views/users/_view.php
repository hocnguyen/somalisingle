<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('seeking')); ?>:</b>
	<?php echo CHtml::encode($data->seeking); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('hair')); ?>:</b>
	<?php echo CHtml::encode($data->hair); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('living_current')); ?>:</b>
	<?php echo CHtml::encode($data->living_current); ?>
	<br />
